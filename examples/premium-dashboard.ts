/**
 * Ejemplo de Dashboard Premium con @webviewjs/webview
 * 
 * Demuestra las capacidades de diseño moderno y rendimiento.
 */
...
async function main() {
  try {
    ...
    // 1. Crear la ventana principal con estilo premium
    ...
    // 2. HTML con diseño de vanguardia
    const dashboardHtml = `
      <!DOCTYPE html>
      <html lang="es">
      <head>
        ...
        <div class="main-content">
          <header>
            <div>
              ...
              <p style="color: var(--text-dim); margin-top: 4px;">Bienvenido de nuevo, Administrador</p>
            </div>
            <button onclick="updateStats()">Refrescar</button>
          </header>
          ...
          <div class="grid">
            ...
            <div class="card">
              ...
              <div class="card-value">12.5 Mb/s</div>
            </div>
          </div>

          <div style="margin-top: 2rem;">
            <h3><span class="pulse"></span> Actividad Real-time</h3>
    ...
    console.log('✓ Premium Dashboard iniciado correctamente')
    eventLoop.run()
  } catch (error) {
